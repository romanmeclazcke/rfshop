...
public class CreateReportUseCaseImpl implements CreateReportUseCase{
    ...
    @Autowired
    public CreateReportUseCaseImpl(ReportRepository reportRepository, ReportMapper reportMapper, ReviewRepository reviewRepository, GetUserByEmail getUserByEmail, ExtractUserEmailFromSecurityContext extractUserEmailFromSecurityContext) {
